...
import voiceRecognize.backbone
weight_decay = 1e-4
...
def vggvox_resnet2d_icassp(input_dim=(257, 250, 1), num_class=8631, mode='train', args=None):
    ...
    aggregation = 'gvlad'
    print("model  使用GPU")
    #mgpu = len(keras.backend.tensorflow_backend._get_available_gpus())# my GPU
